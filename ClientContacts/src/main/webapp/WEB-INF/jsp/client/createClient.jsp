...
<html>
    ...
    <body style="margin-top:0px; padding-left: 70px; ">
        ...
        <h2 style="color:blue">Add Client</h2>
        ...
        <form action="${pageContext.request.contextPath}/client/createClient" method="POST">
            <br/>
            <div>
            ...
            <div>
            <label class="lbl" for="phoneNumber">Phone Number:</label>
            </div>
            <div>
            ...
            <div>
            <input type="text" style="width: 8%;" name="state" value="${client.state}" required pattern="[A-Z]{2}"/>
            </div>
            <br/>
            ...
            <div>
            <input type="text" style="width: 8%;"  name="zipCode" value="${client.zipCode}" required pattern="[0-9]{5}"/>
            </div>
            <br/>
